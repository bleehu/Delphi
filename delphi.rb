...
module Examples
  module HelloCube
    ...
    unless file_loaded?(__FILE__)
      ...
      ex = SketchupExtension.new('Delphi', 'delphi/main')
      ...
      # extensions.
      ex.description = 'A Plugin to interface with Python Scripts to allow moving of models over a network.'
      ex.version     = '0.0.1'
      ex.copyright   = 'none'
      ex.creator     = 'Mike Hedges'
